    ...
    <div class="upGradeContainer">
        ...
        <section class="input_container">
          <div style="margin-left:8%;">
            <span>最大收益：</span>
            <input type="text" readOnly="true" v-model.lazy="cardMaxproft">
          </div>
          <!-- <div style="margin-left:13%;">
            <span>注册码：</span>
            <input type="text" readOnly="true"  v-model.lazy="needRegisterNum">
          </div> -->
          <div style="margin-left:13%;">
            <span>消费码：</span>
            <input type="text" readOnly="true"  v-model.lazy="needActiveNum">
          </div>
          <div style="margin-left:13%;">
            <span>购物币：</span>
            <input type="text" readOnly="true" v-model.lazy="needBuyNum">
          </div>
          <div style="margin-left:13%;">
            <span>交易币：</span>
            ...
            toggleTabs (index,tabText) {
             ...
             async selCard (index) {
                  ...
                  if(res.code == 200){
                    ...
                    this.needRegisterNum=res.result.registerCodeNo//需要补充注册码数量
